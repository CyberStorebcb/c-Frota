    ...
    grupos: [
      {
        ...
        itens: [
          ...
          { id: 'sky-03', label: 'Rodas (verifique sinais de afrouxamento)', imperativo: true },
          ...
          { id: 'sky-08', label: 'Porta escada (Base, cinta de amarração)' },
          ...
          { id: 'sky-11', label: 'Faróis, piscas, lanternas e luz do freio (verificar funcionamento)', imperativo: true },
          { id: 'sky-11-impl', label: 'Lanterna de sinalização direcional do Implemento (Em veículos COMODATO)' },
    ...
    grupos: [
      {
        ...
        itens: [
          ...
          { id: 'mnk-03', label: 'Rodas (verifique sinais de afrouxamento)', imperativo: true },
          ...
          { id: 'mnk-06', label: 'Porta escada (Base, cinta de amarração)' },
          ...
          { id: 'mnk-19', label: 'Cabine e cabine auxiliar (verifique a higienização, vidros, portas, objetos)' },
    ...
    grupos: [
      {
        ...
        itens: [
          ...
          { id: 'pl-07', label: 'Rodas (verifique sinais de afrouxamento)', imperativo: true },
          { id: 'pl-08', label: 'Placas e lacre (verifique estado)', imperativo: true },
          { id: 'pl-09', label: 'Limpeza interna da cabine' },
          { id: 'pl-10', label: 'Painel, Vidros (para-brisa), Portas (travas sem funcionar)', imperativo: true },
          { id: 'pl-10-forra', label: 'Forrações e Bancos' },
          { id: 'pl-11', label: 'Porta escada (base, cinta de amarração)' },
          { id: 'pl-12', label: 'Veículo possui compartimento para guarda dos materiais (MALÃO) com cadeados/fechaduras?' },
        ],
      },
      {
        id: 'dentro_veiculo',
    ...
    grupos: [
      {
        ...
        itens: [
          ...
          { id: 'p4-07', label: 'Rodas (verifique sinais de afrouxamento)', imperativo: true },
          { id: 'p4-08', label: 'Placas e lacre (verifique estado)', imperativo: true },
          { id: 'p4-09', label: 'Limpeza interna da cabine' },
          { id: 'p4-10', label: 'Painel, Vidros (para-brisa), Portas (travas sem funcionar)', imperativo: true },
          { id: 'p4-10-forra', label: 'Forrações e Bancos' },
          { id: 'p4-11', label: 'Porta escada (base, cinta de amarração)' },
          { id: 'p4-12', label: 'Veículo possui compartimento para guarda dos materiais (MALÃO) com cadeados/fechaduras?' },
        ],
      },
      {
        id: 'dentro_veiculo',
    ...
    grupos: [
      {
        ...
        itens: [
          ...
          { id: 'mt-09', label: 'Paralama dianteiro — verificar se possui' },
          { id: 'mt-10', label: 'Paralama traseiro — verificar se possui' },
          ...
          { id: 'mt-14', label: 'Capa do banco (verificar estado de conservação, rasgos)' },
          ...
          { id: 'mt-18', label: 'Carenagens - verificar quebra (impeditivo)', imperativo: true },
    ...
    grupos: [
      {
        ...
        itens: [
          ...
          { id: 'vl-07', label: 'Rodas (verifique sinais de afrouxamento)', imperativo: true },
          { id: 'vl-08', label: 'Placas e lacre (verifique estado)', imperativo: true },
          { id: 'vl-09', label: 'Limpeza interna da cabine' },
          { id: 'vl-10', label: 'Painel, Vidros (para-brisa), Portas (travas sem funcionar)', imperativo: true },
          { id: 'vl-10-forra', label: 'Forrações e Bancos' },
